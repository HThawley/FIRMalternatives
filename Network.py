...
def Transmission(solution):
    ...
    solution.MImport = (solution.MLoad + solution.MCharge + solution.MSpillage - solution.MPV - solution.MOnsW
                - solution.MPeak - solution.MDischarge - solution.MDeficit - np.atleast_2d(solution.CBaseload)).T 
